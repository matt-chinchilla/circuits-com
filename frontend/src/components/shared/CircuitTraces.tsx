  ...
  return (
    ...
    >
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="420" y="130" width="90" height="90" rx="2" {...S(0.12, 1)} fill="rgba(218,190,65,0.02)" className={styles.trace} style={T(0.2)} />
      {/* Notch */}
      ...
      {[430,440,450,460,470,480,490,500].map((x, i) => (
        <rect key={`ic1t${i}`} x={x-1.5} y={121} width={3} height={9} rx={0.5} fill={`rgba(218,190,65,${0.25})`} className={styles.trace} style={T(0.3 + i*0.05)} />
      ))}
      {/* Bottom pads */}
      {[430,440,450,460,470,480,490,500].map((x, i) => (
        <rect key={`ic1b${i}`} x={x-1.5} y={220} width={3} height={9} rx={0.5} fill={`rgba(218,190,65,${0.25})`} className={styles.trace} style={T(0.3 + i*0.05)} />
      ))}
      {/* Left pads */}
      {[140,150,160,170,180,190,200,210].map((y, i) => (
        <rect key={`ic1l${i}`} x={411} y={y-1.5} width={9} height={3} rx={0.5} fill={`rgba(218,190,65,${0.25})`} className={styles.trace} style={T(0.4 + i*0.05)} />
      ))}
      {/* Right pads */}
      {[140,150,160,170,180,190,200,210].map((y, i) => (
        <rect key={`ic1r${i}`} x={510} y={y-1.5} width={9} height={3} rx={0.5} fill={`rgba(218,190,65,${0.25})`} className={styles.trace} style={T(0.4 + i*0.05)} />
      ))}

      {/* ═══════════════════════════════════════════════════════════════════════
          QFP IC Package 2 — small, right (body at 920,100 → 970,150)
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="920" y="100" width="50" height="50" rx="2" {...S(0.1, 0.8)} fill="rgba(218,190,65,0.02)" className={styles.trace} style={T(2.5)} />
      {/* Top pads */}
      ...
      {/* Right pads */}
      {[110,120,130,140].map((y, i) => (
        <rect key={`ic2r${i}`} x={970} y={y-1} width={7} height={2.5} rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(2.7 + i*0.05)} />
      ))}

      {/* ═══════════════════════════════════════════════════════════════════════
          SOIC IC Package 3 — bottom-left (body at 140,280 → 200,320)
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="140" y="280" width="60" height="40" rx="2" {...S(0.09, 0.8)} fill="rgba(218,190,65,0.015)" className={styles.trace} style={T(3.0)} />
      {[150,160,170,180,190].map((x, i) => (
        <g key={`ic3p${i}`}>
          <rect x={x-1} y={273} width={2.5} height={7} rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.1 + i*0.04)} />
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="575" y="30" width="30" height="16" rx={3} {...S(0.1, 0.8)} fill="rgba(218,190,65,0.02)" className={styles.trace} style={T(1.6)} />
      {/* 4 pads at corners */}
      <rect x="578" y="26" width="4" height="4" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="598" y="26" width="4" height="4" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="578" y="46" width="4" height="4" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="598" y="46" width="4" height="4" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.7)} />
      ...
      <rect x="82" y="193" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.6)} />
      <rect x="96" y="193" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.6)} />
      <rect x="89" y="206" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(1.6)} />
      ...
      <rect x="1032" y="303" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.6)} />
      <rect x="1046" y="303" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.6)} />
      <rect x="1039" y="316" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.6)} />
      ...
      />
      {/* Pads at coil ends */}
      <rect x="323" y="257" width="7" height="6" rx={1} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(2.0)} />
      <rect x="375" y="257" width="7" height="6" rx={1} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(2.0)} />
      {/* Coil traces */}
      ...
      <path d="M840 343 L855 350 L840 357 Z" {...S(0.09, 0.8)} fill="rgba(218,190,65,0.04)" className={styles.trace} style={T(3.4)} />
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <circle cx="620" cy="240" r="10" {...S(0.08, 0.8)} fill="rgba(218,190,65,0.015)" className={styles.trace} style={T(2.1)} />
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="485" y="365" width="50" height="25" rx={2} {...S(0.07, 0.6)} fill="rgba(218,190,65,0.01)" className={styles.trace} style={T(3.2)} />
      {/* Shield tabs */}
      <rect x="483" y="370" width="4" height="15" rx={1} fill="rgba(218,190,65,0.08)" className={styles.trace} style={T(3.2)} />
      <rect x="533" y="370" width="4" height="15" rx={1} fill="rgba(218,190,65,0.08)" className={styles.trace} style={T(3.2)} />
      {/* Signal pins */}
      {[495,503,511,519,527].map((x, i) => (
        <rect key={`usb${i}`} x={x-1} y={390} width={2.5} height={6} rx={0.5} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(3.3 + i*0.03)} />
      ))}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      {/* Body outline */}
      <rect x="1090" y="160" width="30" height="20" rx={1.5} {...S(0.08, 0.7)} fill="rgba(218,190,65,0.015)" className={styles.trace} style={T(3.4)} />
      {/* Large thermal pad on top */}
      <rect x="1098" y="154" width="14" height="6" rx={1} fill="rgba(218,190,65,0.1)" className={styles.trace} style={T(3.5)} />
      {/* 3 small pads on bottom */}
      <rect x="1094" y="180" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.5)} />
      <rect x="1103" y="180" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.5)} />
      <rect x="1112" y="180" width="4" height="5" rx={0.5} fill="rgba(218,190,65,0.09)" className={styles.trace} style={T(3.5)} />
      {/* Regulator traces */}
