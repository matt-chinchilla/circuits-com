...
const S = (o: number, w = 1) => ({ stroke: `rgba(255,255,255,${o})`, strokeWidth: w });
  ...
  return (
    ...
    >
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="420" y="130" width="90" height="90" rx="2" {...S(0.12, 1)} fill="rgba(255,255,255,0.02)" className={styles.trace} style={T(0.2)} />
      {/* Notch */}
      ...
      {[430,440,450,460,470,480,490,500].map((x, i) => (
        <rect key={`ic1t${i}`} x={x-1.5} y={121} width={3} height={9} rx={0.5} fill={`rgba(255,255,255,${0.12})`} className={styles.trace} style={T(0.3 + i*0.05)} />
      ))}
      {/* Bottom pads */}
      {[430,440,450,460,470,480,490,500].map((x, i) => (
        <rect key={`ic1b${i}`} x={x-1.5} y={220} width={3} height={9} rx={0.5} fill={`rgba(255,255,255,${0.12})`} className={styles.trace} style={T(0.3 + i*0.05)} />
      ))}
      {/* Left pads */}
      {[140,150,160,170,180,190,200,210].map((y, i) => (
        <rect key={`ic1l${i}`} x={411} y={y-1.5} width={9} height={3} rx={0.5} fill={`rgba(255,255,255,${0.12})`} className={styles.trace} style={T(0.4 + i*0.05)} />
      ))}
      {/* Right pads */}
      {[140,150,160,170,180,190,200,210].map((y, i) => (
        <rect key={`ic1r${i}`} x={510} y={y-1.5} width={9} height={3} rx={0.5} fill={`rgba(255,255,255,${0.12})`} className={styles.trace} style={T(0.4 + i*0.05)} />
      ))}

      {/* ═══════════════════════════════════════════════════════════════════════
          QFP IC Package 2 — small, right (body at 920,100 → 970,150)
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="920" y="100" width="50" height="50" rx="2" {...S(0.1, 0.8)} fill="rgba(255,255,255,0.02)" className={styles.trace} style={T(2.5)} />
      {/* Top pads */}
      {[930,940,950,960].map((x, i) => (
        <rect key={`ic2t${i}`} x={x-1} y={93} width={2.5} height={7} rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.6 + i*0.05)} />
      ))}
      {/* Bottom pads */}
      {[930,940,950,960].map((x, i) => (
        <rect key={`ic2b${i}`} x={x-1} y={150} width={2.5} height={7} rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.6 + i*0.05)} />
      ))}
      {/* Left pads */}
      {[110,120,130,140].map((y, i) => (
        <rect key={`ic2l${i}`} x={913} y={y-1} width={7} height={2.5} rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.7 + i*0.05)} />
      ))}
      {/* Right pads */}
      {[110,120,130,140].map((y, i) => (
        <rect key={`ic2r${i}`} x={970} y={y-1} width={7} height={2.5} rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.7 + i*0.05)} />
      ))}

      {/* ═══════════════════════════════════════════════════════════════════════
          SOIC IC Package 3 — bottom-left (body at 140,280 → 200,320)
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="140" y="280" width="60" height="40" rx="2" {...S(0.09, 0.8)} fill="rgba(255,255,255,0.015)" className={styles.trace} style={T(3.0)} />
      {[150,160,170,180,190].map((x, i) => (
        <g key={`ic3p${i}`}>
          <rect x={x-1} y={273} width={2.5} height={7} rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.1 + i*0.04)} />
          <rect x={x-1} y={320} width={2.5} height={7} rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.1 + i*0.04)} />
        </g>
      ))}
      ...
      <rect x="445" y="82" width="8" height="5" rx={1} fill="rgba(255,255,255,0.12)" className={styles.trace} style={T(0.7)} />
      <rect x="457" y="82" width="8" height="5" rx={1} fill="rgba(255,255,255,0.12)" className={styles.trace} style={T(0.7)} />
      {/* SMD 2 */}
      <rect x="530" y="155" width="8" height="5" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.0)} />
      <rect x="542" y="155" width="8" height="5" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.0)} />
      {/* SMD 3 */}
      <rect x="370" y="175" width="5" height="8" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.2)} />
      <rect x="370" y="187" width="5" height="8" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.2)} />
      {/* SMD 4 — near IC2 */}
      <rect x="870" y="118" width="7" height="4" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.3)} />
      <rect x="881" y="118" width="7" height="4" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.3)} />
      {/* SMD 5 */}
      <rect x="1000" y="135" width="7" height="4" rx={1} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.2)} />
      <rect x="1011" y="135" width="7" height="4" rx={1} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.2)} />
      {/* SMD 6 — bottom area */}
      <rect x="650" y="310" width="5" height="8" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(3.8)} />
      <rect x="650" y="322" width="5" height="8" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(3.8)} />
      {/* SMD 7 */}
      <rect x="780" y="260" width="8" height="4" rx={1} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.5)} />
      <rect x="792" y="260" width="8" height="4" rx={1} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.5)} />
      {/* SMD 8 — far left */}
      <rect x="60" y="160" width="7" height="4" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(1.8)} />
      <rect x="71" y="160" width="7" height="4" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(1.8)} />
      {/* SMD 9 — top center */}
      <rect x="700" y="50" width="4" height="7" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(2.0)} />
      <rect x="700" y="61" width="4" height="7" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(2.0)} />
      {/* SMD 10 */}
      <rect x="300" y="340" width="8" height="4" rx={1} fill="rgba(255,255,255,0.07)" className={styles.trace} style={T(4.2)} />
      <rect x="312" y="340" width="8" height="4" rx={1} fill="rgba(255,255,255,0.07)" className={styles.trace} style={T(4.2)} />
      ...
      {[30,50,70,90,110,130].map((x, i) => (
        <g key={`th${i}`}>
          <circle cx={x} cy={40} r={4.5} fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.1)" strokeWidth={1} className={styles.node} style={T(0.1 + i*0.15)} />
          <circle cx={x} cy={40} r={1.5} fill="rgba(255,255,255,0.15)" className={styles.node} style={T(0.1 + i*0.15)} />
        </g>
      ))}
      {/* Second row */}
      {[30,50,70,90,110,130].map((x, i) => (
        <g key={`th2${i}`}>
          <circle cx={x} cy={60} r={4.5} fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.1)" strokeWidth={1} className={styles.node} style={T(0.2 + i*0.15)} />
          <circle cx={x} cy={60} r={1.5} fill="rgba(255,255,255,0.15)" className={styles.node} style={T(0.2 + i*0.15)} />
        </g>
      ))}
      ...
      {[200,220,240,260,280].map((y, i) => (
        <g key={`thr${i}`}>
          <circle cx={1170} cy={y} r={4} fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" strokeWidth={0.8} className={styles.node} style={T(3.5 + i*0.12)} />
          <circle cx={1170} cy={y} r={1.5} fill="rgba(255,255,255,0.12)" className={styles.node} style={T(3.5 + i*0.12)} />
        </g>
      ))}
      ...
      {[
        ...
        <g key={`via${i}`}>
          <circle cx={cx} cy={cy} r={r as number} fill="rgba(255,255,255,0.04)" stroke="rgba(255,255,255,0.1)" strokeWidth={0.8} className={styles.node} style={T(0.2 + i * 0.13)} />
          <circle cx={cx} cy={cy} r={(r as number) * 0.4} fill="rgba(255,255,255,0.15)" className={styles.node} style={T(0.2 + i * 0.13)} />
        </g>
      ))}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="580" y="200" width="45" height="35" rx={2} fill="rgba(255,255,255,0.02)" stroke="rgba(255,255,255,0.04)" strokeWidth={0.5} className={styles.node} style={T(2.0)} />
      <rect x="1050" y="150" width="35" height="45" rx={2} fill="rgba(255,255,255,0.02)" stroke="rgba(255,255,255,0.04)" strokeWidth={0.5} className={styles.node} style={T(3.6)} />
      <rect x="200" y="320" width="50" height="30" rx={2} fill="rgba(255,255,255,0.015)" stroke="rgba(255,255,255,0.035)" strokeWidth={0.5} className={styles.node} style={T(3.2)} />

      {/* ═══════════════════════════════════════════════════════════════════════
          Decoupling caps near IC corners + pull-up resistor pads
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="415" y="110" width="6" height="3" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(0.5)} />
      <rect x="425" y="110" width="6" height="3" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(0.5)} />
      <rect x="499" y="110" width="6" height="3" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(0.6)} />
      <rect x="509" y="110" width="6" height="3" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(0.6)} />
      <rect x="915" y="85" width="5" height="3" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(2.4)} />
      <rect x="923" y="85" width="5" height="3" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(2.4)} />
      <rect x="345" y="95" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(0.9)} />
      <rect x="345" y="105" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(0.9)} />
      <rect x="355" y="95" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(0.9)} />
      <rect x="355" y="105" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(0.9)} />
      <rect x="365" y="95" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(1.0)} />
      <rect x="365" y="105" width="3" height="6" rx={0.5} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(1.0)} />

      {/* ═══════════════════════════════════════════════════════════════════════
          BGA Package — grid of solder balls (center-right, 740,260)
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="730" y="250" width="44" height="44" rx={2} {...S(0.08, 0.6)} fill="rgba(255,255,255,0.015)" className={styles.trace} style={T(2.2)} />
      {[0,1,2,3].map(row =>
        [0,1,2,3].map(col => (
          <circle key={`bga${row}${col}`} cx={740 + col*10} cy={260 + row*10} r={2} fill="rgba(255,255,255,0.1)" className={styles.node} style={T(2.3 + (row*4+col)*0.04)} />
        ))
      )}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="575" y="30" width="30" height="16" rx={3} {...S(0.1, 0.8)} fill="rgba(255,255,255,0.02)" className={styles.trace} style={T(1.6)} />
      {/* 4 pads at corners */}
      <rect x="578" y="26" width="4" height="4" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="598" y="26" width="4" height="4" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="578" y="46" width="4" height="4" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.7)} />
      <rect x="598" y="46" width="4" height="4" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.7)} />
      ...
      <rect x="82" y="193" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.6)} />
      <rect x="96" y="193" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.6)} />
      <rect x="89" y="206" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(1.6)} />
      ...
      <rect x="1032" y="303" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.6)} />
      <rect x="1046" y="303" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.6)} />
      <rect x="1039" y="316" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.6)} />
      ...
      />
      {/* Pads at coil ends */}
      <rect x="323" y="257" width="7" height="6" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.0)} />
      <rect x="375" y="257" width="7" height="6" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(2.0)} />
      {/* Coil traces */}
      ...
      <path d="M840 343 L855 350 L840 357 Z" {...S(0.09, 0.8)} fill="rgba(255,255,255,0.04)" className={styles.trace} style={T(3.4)} />
      ...
      <path d="M193 145 L200 160 L207 145 Z" {...S(0.08, 0.8)} fill="rgba(255,255,255,0.03)" className={styles.trace} style={T(1.4)} />
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <circle cx="620" cy="240" r="10" {...S(0.08, 0.8)} fill="rgba(255,255,255,0.015)" className={styles.trace} style={T(2.1)} />
      ...
      {[
        ...
        <g key={label as string}>
          <circle cx={x as number} cy={y as number} r={3.5} fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.12)" strokeWidth={1} className={styles.node} style={T(2.5)} />
          <circle cx={x as number} cy={y as number} r={1} fill="rgba(255,255,255,0.18)" className={styles.node} style={T(2.5)} />
        </g>
      ))}
      ...
      {[[25, 380], [1175, 20], [1175, 380]].map(([x, y], i) => (
        <g key={`fid${i}`}>
          ...
          <circle cx={x} cy={y} r={1.2} fill="rgba(255,255,255,0.12)" className={styles.node} style={T(0.1)} />
        </g>
      ))}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      <rect x="485" y="365" width="50" height="25" rx={2} {...S(0.07, 0.6)} fill="rgba(255,255,255,0.01)" className={styles.trace} style={T(3.2)} />
      {/* Shield tabs */}
      <rect x="483" y="370" width="4" height="15" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(3.2)} />
      <rect x="533" y="370" width="4" height="15" rx={1} fill="rgba(255,255,255,0.08)" className={styles.trace} style={T(3.2)} />
      {/* Signal pins */}
      {[495,503,511,519,527].map((x, i) => (
        <rect key={`usb${i}`} x={x-1} y={390} width={2.5} height={6} rx={0.5} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(3.3 + i*0.03)} />
      ))}
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════════ */}
      {/* Body outline */}
      <rect x="1090" y="160" width="30" height="20" rx={1.5} {...S(0.08, 0.7)} fill="rgba(255,255,255,0.015)" className={styles.trace} style={T(3.4)} />
      {/* Large thermal pad on top */}
      <rect x="1098" y="154" width="14" height="6" rx={1} fill="rgba(255,255,255,0.1)" className={styles.trace} style={T(3.5)} />
      {/* 3 small pads on bottom */}
      <rect x="1094" y="180" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.5)} />
      <rect x="1103" y="180" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.5)} />
      <rect x="1112" y="180" width="4" height="5" rx={0.5} fill="rgba(255,255,255,0.09)" className={styles.trace} style={T(3.5)} />
      {/* Regulator traces */}
