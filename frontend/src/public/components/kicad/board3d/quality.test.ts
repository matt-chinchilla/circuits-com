...
// One setting, decided once, from WebGL2 + window width and nothing else (spec §6,
// amended 2026-09-22: the pixel ratio is not a tier input — a 2.24× desktop
// display put a real GPU on the reduced tier). The
...
describe('decideQuality', () => {
  it.each([
    ...
    ['the width threshold exactly met', env(true, 900, 2), 'full'],
