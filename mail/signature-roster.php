...
return [
    ...
    'company' => [
        ...
        /**
         * Which social marks actually exist, so the template knows when NOT to
         * emit one.
         *
         * sig_social builds a URL on another host and can never stat the file,
         * so without this it validated the slug's grammar and emitted an <img>
         * regardless -- and a label with no mark produced a BROKEN IMAGE in the
         * recipient's inbox rather than the text link the design promised.
         * Harmless while this file held three known names; a guarantee the
         * moment anyone can type a label of their own.
         *
         * Generated by mail/make-signature-assets.py, which is the only thing
         * that creates those files, so the list cannot drift from them.
         * test_template.php asserts the two still agree.
         */
        'icon_slugs' => require __DIR__ . '/signature-icon-slugs.php',
